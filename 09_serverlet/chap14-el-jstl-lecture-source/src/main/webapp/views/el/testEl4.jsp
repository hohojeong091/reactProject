...
<body>
<h1> requestScope 와 sessionScope</h1>
<h3>requestScope</h3>
...
만약 member라는 값이 requestScope에 없었을 경우에는 sessionScope의 값이 출력된다 -->
이름 : #{ Scope.member.name } <br>
나이 : #{ Scope.member.age } <br>
전화번호 : #{ Scope.member.phone } <br>
이메일 : #{ Scope.member.email } <br>
</body>
</html>
